...
def write_to_csv(list_input, name='allGroceries', directory='./Mercado'):
    ...
    if (os.path.isfile(directory+name+'.csv')) is not True:
        saveItem(['ID', 'PRODUTO', 'PRECO-FINAL', 'PRECO-CHEIO',
                 'PRECO/KG', 'PRECO/L', 'SECAO', 'MERCADO'],
                 name, directory)
...
def scroll(browser):
    ...
    while True:
        ...
        if last_number == new_number:
            ...
            count = 0
        if (count > 30) or (stop_no_product(cards) is True):
            print(False)
            break
...
if __name__ == "__main__":
    directory = './Mercado'
    pages = ['https://www.tendaatacado.com.br/mercearia',
             'https://www.tendaatacado.com.br/bebidas',
             'https://www.tendaatacado.com.br/congelados',
             'https://www.tendaatacado.com.br/frios-e-laticinios',
             'https://www.tendaatacado.com.br/carnes-aves-e-peixes',
             'https://www.tendaatacado.com.br/limpeza',
             'https://www.tendaatacado.com.br/higiene-e-perfumaria',
             'https://www.tendaatacado.com.br/bebe',
             'https://www.tendaatacado.com.br/bomboniere',
             'https://www.tendaatacado.com.br/hortifruti',
             'https://www.tendaatacado.com.br/paes-e-bolos',
             'https://www.tendaatacado.com.br/bazar',
             'https://www.tendaatacado.com.br/pet-shop',
             ]
    directory = directory + '_' + dt.datetime.now().date().isoformat() + '/'
    try:
